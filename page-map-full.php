...
<?php get_header(); ?>
			...
			<div id="info-container" class="row-fluid">
				<div class="span12 well dropShadow" style="margin-left:0px;margin-top:10px;">
					<div class="span6">
					...
					<div class="span6">
						<iframe src="http://player.vimeo.com/video/47109199" width="420" height="261" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
					</div>
				</div>
			</div>	
