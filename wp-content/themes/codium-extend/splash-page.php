...
<body style="background:url(<?php echo get_template_directory_uri(); ?>/splashPage/assets/img/tile.jpeg) repeat !important;>
    <div class="container">
		<div id="homeMain" >
			<div id="quotes"></div> 
			<div id="winc"></div>
			...
			<div id="homeLinks">
				...
				<p><a href="">SOC 119</a></p>	
				<p><class="pos_right"><a href="converse.html">Join A Conversation</a></p>	
			</div>
		</div>
